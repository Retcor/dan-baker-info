  ...
  return (
    <>
      ...
      >
        ...
        I'm a quick learner who picks up new technologies quickly by building out personal projects. In fact, this website was an opportunity
        to learn Kubernetes, Docker, React and Tailwind CSS, as this is deployed in Google Cloud Platform using their Kubernetes engine.<br/><br/>
